...
| `check_prose.py` | 43 files | nothing | No machine-writing tells across 28 pages and 15 documents, 34,476 words: no tool leak markers, no scaffold headings, no participial tails, no copula avoidance, no em dash anywhere |
