...
| `check_prose.py` | 44 files | nothing | No machine-writing tells across 28 pages and 16 documents, 44,218 words: no tool leak markers, no scaffold headings, no participial tails, no copula avoidance, no em dash anywhere |
